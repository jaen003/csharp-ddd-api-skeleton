...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Src.Core.Products.Infrastructure.Models.ProductModel", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Src.Core.Restaurants.Infrastructure.Models.RestaurantModel", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Src.Core.Products.Infrastructure.Models.ProductModel", b =>
                {
                    b.HasOne("Src.Core.Restaurants.Infrastructure.Models.RestaurantModel", "Restaurant")
                        .WithMany()
